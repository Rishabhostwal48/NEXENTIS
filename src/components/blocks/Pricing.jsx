    ...
    <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
      {pricingPlans.map((plan) => (
        <div
          key={plan.id}
          className={[
            "rounded-xl border p-8 backdrop-blur-xl bg-white/70 dark:bg-neutral-950/30 hover:shadow-soft-lg transition-all duration-normal hover-lift",
            plan.highlighted
              ? "gradient-border border-neutral-200/70 dark:border-neutral-800/70 shadow-soft-md"
              : "border-neutral-200/70 dark:border-neutral-800/70 shadow-soft-sm",
          ].join(" ")}
        >
          {plan.highlighted ? (
